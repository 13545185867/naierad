package com.jeecg.p3.messageLog.web.back;
 ...
 */
@Controller
@RequestMapping("/messageLog/back/sendMessageLog")
public class SendMessageLogController extends BaseController{
  @Autowired
...
public void list(@ModelAttribute SendMessageLog query,HttpServletResponse response,HttpServletRequest request,
			@RequestParam(required = false, value = "pageNo", defaultValue = "1") int pageNo,
			@RequestParam(required = false, value = "pageSize", defaultValue = "10") int pageSize) throws Exception{
	 	PageQuery<SendMessageLog> pageQuery = new PageQuery<SendMessageLog>();
	 	pageQuery.setPageNo(pageNo);
	 	pageQuery.setPageSize(pageSize);
	 	VelocityContext velocityContext = new VelocityContext();
		pageQuery.setQuery(query);
		velocityContext.put("sendMessageLog",query);
		velocityContext.put("pageInfos",SystemTools.convertPaginatedList(sendMessageLogService.queryPageList(pageQuery)));
		String viewName = "messageLog/back/sendMessageLog-list.vm";
...
@ResponseBody
public AjaxJson doAdd(@ModelAttribute SendMessageLog sendMessageLog){
